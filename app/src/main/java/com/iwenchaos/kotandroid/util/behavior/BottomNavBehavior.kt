package com.iwenchaos.kotandroid.util.behavior
 ...
 * 文件描述：
 */
class BottomNavBehavior(context: Context,attrs: AttributeSet): CoordinatorLayout.Behavior<BottomNavigationView>(context ,attrs) {
