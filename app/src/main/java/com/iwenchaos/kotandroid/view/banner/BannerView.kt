package com.iwenchaos.kotandroid.view.banner
...
import com.iwenchaos.kotandroid.ui.main.adapter.BannerPagerAdapter
import com.iwenchaos.kotandroid.util.DensityUtil
import com.iwenchaos.kotandroid.util.transformer.ZoomPageTransformer
import com.iwenchaos.kotandroid.view.CirclePagerIndicator
import com.iwenchaos.kotandroid.view.FixedSpeedScroller
...
class BannerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private fun initView(context: Context) {
        ...
        viewPager.setPageTransformer(
            true, ZoomPageTransformer(viewPager)
    ...
    private fun setupPagerAdapter(bannerList: List<HomeBannerData>, screenWidth: Int, resultHeight: Int) {
        ...
        val item =
            mBannerList.size * BannerPagerAdapter.SIZE_MULTIPLE / 2 - ((mBannerList.size * BannerPagerAdapter.SIZE_MULTIPLE) % mBannerList.size)
